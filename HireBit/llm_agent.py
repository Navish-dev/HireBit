...
"ai_generated_probability": an integer from 0 to 100 representing the likelihood this was generated by an AI (based on burstiness, robotic tone, and perplexity)
"ai_detection_reasoning": a concise 1-sentence explanation for the probability
"""
    ...
    try:
        ...
        return {
            "correctness_score": -1, 
            "reasoning": "Evaluation failed or unsupported.", 
            "ai_generated_probability": 0, 
            "ai_detection_reasoning": "N/A"
        }
