...
def generate_flag_json(
    ...
    if "ai_generation" in signals and signals["ai_generation"]["triggered"]:
        reasoning_parts.append(f"AI generation probability at {signals['ai_generation']['probability']}%")
    ...
    flag_payload = {
        ...
        "signals": {
            "ai_generation": signals.get("ai_generation", {"triggered": False, "probability": 0}),
